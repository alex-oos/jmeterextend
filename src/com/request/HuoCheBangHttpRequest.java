...
public class HuoCheBangHttpRequest extends Request{
	...
	public HuoCheBangHttpRequest(String address,String label,String method) {
	    	...
	    	if (maparg!=null) {
	    		...
	    		if (method.equals("POST")) {
	    			for (Entry entry : (Set<Entry>)maparg.entrySet()) {
		    			...
		    			jsonObject=jsonObject+(String)entry.getKey()+"="+(String)entry.getValue()+"&";
		    		}
