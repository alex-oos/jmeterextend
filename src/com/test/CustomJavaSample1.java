...
public class CustomJavaSample1 implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			...
			//在属于自己的list里随机获取一条数据
			String result=	db.select1().toString();
            //设置接受数据完成的时间
			...
			e.printStackTrace();
			try {
				FileUtils.writeStringToFile(new File("exception.log"), Usualutil.exceptionToString(e), "utf-8");
