...
public class Get_set_timeSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/paymentapp/get_set_time/", "获取跳转设置的秒数", "POST").run(mapuptoken);
...
//		SampleResult get_set_timeSample =new Get_set_timeSample().runTest(null);
//	}
