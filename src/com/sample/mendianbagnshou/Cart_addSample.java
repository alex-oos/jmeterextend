...
public class Cart_addSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    //购物车添加商品
  		...
  		map_data.put("client_type", "android");
  		map_data.put("quantity", "1");
		...
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/member_cart/cart_add", "购物车添加商品", "POST").run(map);
