...
public class Pay_password2Sample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		map_orderpay_password_head2.put("token", token);
		map_orderpay_password2.put("head", map_orderpay_password_head2);
		
		try {
			Map pay_passwordmap=(Map)map_orderpay_password2;
