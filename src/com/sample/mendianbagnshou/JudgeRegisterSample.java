...
public class JudgeRegisterSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/ebaoping/judgeRegister", "获取店铺是否注册如意宝接口", "POST").run(map);
