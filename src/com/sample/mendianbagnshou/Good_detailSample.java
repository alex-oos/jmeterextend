...
public class Good_detailSample implements JavaSamplerClient {
...
//	    q++;
		...
		map_ordergoods_detail_head.put("token", token);
		...
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/goods/goods_detail", "商品详情", "POST").run(map_ordergoods_detail);
