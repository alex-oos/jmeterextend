...
public class Chain_auth_infoSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/member_index/chain_auth_info", "门店信息获取", "POST").run(map);
...
//			SampleResult sampleResult = new Chain_auth_infoSample().runTest(null);
//
//			System.out.println(new String(sampleResult.getResponseCode()));
//
//		}
//	}
