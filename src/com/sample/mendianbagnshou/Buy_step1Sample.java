...
public class Buy_step1Sample implements JavaSamplerClient {
	...
	static{
		...
		goodidlist.add("286264");
		goodidlist.add("169547");
		goodidlist.add("235789");
		goodidlist.add("118154");
		goodidlist.add("233033");
		goodidlist.add("249719");
		goodidlist.add("249719");
...
//		SampleResult buy_step1Sample =new Buy_step1Sample().runTest(null);
//	}
