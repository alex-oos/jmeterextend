...
public class Cart_listSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/member_cart/cart_list", "购物车列表1", "POST").run(mapuptoken);
...
//		SampleResult cart =new Cart_listSample().runTest(null);
//	}
