...
public class Get_home_page1Sample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		mapget_home_page1_head.put("token", token);
		mapget_home_page1.put("head", mapget_home_page1_head);
	  		
  		
		try {
			SampleResult sampleResultsub= new HttpRequest("/chainapi/v1/home_page/get_home_page1", "获取首页数据", "POST").run(mapget_home_page1);
