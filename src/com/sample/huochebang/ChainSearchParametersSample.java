...
public class ChainSearchParametersSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=Chainnew&op=chainSearchParameters", "门店搜索参数获取", "POST").run(map);
	...
	public static void main(String[] args) {
			SampleResult sampleResult=new ChainSearchParametersSample().runTest(null);
