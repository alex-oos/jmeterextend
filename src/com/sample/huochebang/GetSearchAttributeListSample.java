...
public class GetSearchAttributeListSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=search&op=getSearchAttributeList", "获取搜索页面能进行筛选的规格列表", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetSearchAttributeListSample().runTest(null);
