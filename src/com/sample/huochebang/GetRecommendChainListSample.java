...
public class GetRecommendChainListSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		map_data.put("ats", "236");
		map_data.put("sid", "3771303");
		map_data.put("st", "D2C1DA574D809A06");
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=Chainnew&op=getRecommendChainList&lat=40.051954&lng=116.363092&page=1&pageCount=12&key="+token, "获取推荐的门店列表", "GET").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetRecommendChainListSample().runTest(null);
