...
public class GetGoodsCommentListSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=Comment&op=getGoodsCommentList", "获取商品评价列表", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetGoodsCommentListSample().runTest(null);
