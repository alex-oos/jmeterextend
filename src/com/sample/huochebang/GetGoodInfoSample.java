...
public class GetGoodInfoSample implements JavaSamplerClient {
	...
	static{
		...
		goodidlist.add("586161");
		goodidlist.add("584018");
		goodidlist.add("586166");
		goodidlist.add("714422");
		goodidlist.add("714427");
		goodidlist.add("714437");
		goodidlist.add("588139");
		goodidlist.add("588150");
		goodidlist.add("588143");
		goodidlist.add("584285");
		goodidlist.add("584287");
		goodidlist.add("584294");
		goodidlist.add("586329");
		goodidlist.add("586330");
		goodidlist.add("586333");
		goodidlist.add("586676");
		goodidlist.add("587885");
		goodidlist.add("702346");
		goodidlist.add("744493");
		goodidlist.add("744498");
		goodidlist.add("744504");
		goodidlist.add("603106");
		goodidlist.add("603112");
		goodidlist.add("718781");
		goodidlist.add("719936");
		goodidlist.add("719934");
		goodidlist.add("719937");
		goodidlist.add("712380");
		goodidlist.add("712383");
		goodidlist.add("712392");
		goodidlist.add("824072");
		goodidlist.add("824080");
		goodidlist.add("824077");
		goodidlist.add("821572");
		goodidlist.add("821596");
		goodidlist.add("821599");
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    int q2=(int) (Math.random()*goodidcount);
	    String goodid =(String) goodidlist.get(q2); 
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=goods&op=getGoodInfo&goods_id="+goodid+"&lat=40.051975&lng=116.363082&key="+token, "获取商品详情页数据", "GET").run(map);
...
//			SampleResult sampleResult=new GetGoodInfoSample().runTest(null);
