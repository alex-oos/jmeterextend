...
public class GetGoodListSample implements JavaSamplerClient {
	...
	static{
		...
		keywordlist.add("固特异");
		keywordlist.add("101H  EAGLENCT5");
		keywordlist.add("轮胎205/55R16  安节轮");
		keywordlist.add("B250");
		keywordlist.add("固特异轮胎275/40R19  三能防爆");
		keywordlist.add("H/PSPORT");
		keywordlist.add("SCORPIONATR");
		keywordlist.add("SVAS");
		keywordlist.add("二代");
		keywordlist.add("100W PZEROROSSO");
		keywordlist.add("普利SPORT");
		keywordlist.add("防爆");
		keywordlist.add("固特异");
		keywordlist.add("玛吉斯轮胎MA501");
		keywordlist.add("倍耐力轮胎235/50R19 99W MO PZERO");
		keywordlist.add("普利司通轮胎225/65R17 102H H/L400");
		keywordlist.add("固特异AICE");
		keywordlist.add("倍耐力ZERO");
		keywordlist.add("倍耐PZERO");
		keywordlist.add("固特SUV");
		keywordlist.add("普利H/L33");
		keywordlist.add("倍耐力轮Y AO PZERO");
		keywordlist.add("倍耐力O PZERO");
		keywordlist.add("普利司94V ER33");
		keywordlist.add("固特7V 安节轮");
		keywordlist.add("倍耐力轮0W PZERO");
		keywordlist.add("倍耐力轮  NO PZERO");
		keywordlist.add("玛吉R14 CS735");
		keywordlist.add("倍耐力RO防爆胎");
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		int index=(int)(Math.random()*keywordcount);
	    String keyword=(String) keywordlist.get(index);
		
		Map map =new HashMap<>();
		
		Map map_data =new HashMap<>();
		
		map_data.put("lng", "116.36307");
		map_data.put("lat", "40.051952");
		map_data.put("page", "1");
		map_data.put("pageCount", "12");
		map_data.put("desc", "1");
		map_data.put("field", "");
		map_data.put("descname", "综合排序");
		map_data.put("area_id_1", "");
		map_data.put("area_id_2", "");
		map_data.put("area_id_3", "");
		map_data.put("area_name_1", "");
		map_data.put("area_name_2", "");
		map_data.put("area_name_3", "");
		map_data.put("keywords", keyword);
		map_data.put("brand_id", "");
		map_data.put("columnsName", "");
		map_data.put("price_range", "");
		map_data.put("attr_value_id", "");
		map_data.put("currentPage", "null");
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=search&op=getGoodList", "获取商品列表", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetGoodListSample().runTest(null);
