...
public class SaveLocationSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=log&op=saveLocation", "保存位置信息", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new SaveLocationSample().runTest(null);
