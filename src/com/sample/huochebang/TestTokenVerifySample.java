...
public class TestTokenVerifySample implements JavaSamplerClient {
...
//		list.add("902738a4e66ec88afec92a769708f490");
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			...
			FileUtils.writeStringToFile( new File( "D:\\green\\Desktop\\TestTokenVerifySample.txt" ) ,new String( sampleResultsub.getResponseData())+"\n" ,"UTF-8",true);
		...
		try {
			...
			FileUtils.writeStringToFile( new File( "D:\\green\\Desktop\\TestTokenVerifySample.txt" ) ,new String( sampleResultsub1.getResponseData())+"\n" ,"UTF-8",true);
			System.out.println(new String( sampleResultsub1.getResponseData() ));
			return sampleResultsub1;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) {
				...
				SampleResult sampleResult = new TestTokenVerifySample().runTest( null );
