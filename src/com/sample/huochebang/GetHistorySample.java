...
public class GetHistorySample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=search&op=getHistory&key="+token, "获取用户搜索记录", "GET").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetHistorySample().runTest(null);
