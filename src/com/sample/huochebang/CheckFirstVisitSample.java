...
public class CheckFirstVisitSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/Member/checkFirstVisit?type=index&key="+token, "新手引导", "GET").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new CheckFirstVisitSample().runTest(null);
