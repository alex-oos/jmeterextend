...
public class InvoiceInfoSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=invoice&op=invoiceInfo&key="+token, "获取买家发票信息", "GET").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new InvoiceInfoSample().runTest(null);
