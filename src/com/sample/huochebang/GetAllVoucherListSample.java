...
public class GetAllVoucherListSample implements JavaSamplerClient {
	
	static List list =new ArrayList();
	static List storelist =new ArrayList();
	static int count=0;
	...
	static{
		...
		storelist.add("77061");
		storelist.add("35658");
		storelist.add("111594");
		storelist.add("111305");
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		int q2=(int) (Math.random()*storecount);
	    String storeid =(String) storelist.get(q2); 
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=Voucher&op=getAllVoucherList", "所有可领取的代金券，厂商券，红包列表", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetAllVoucherListSample().runTest(null);
