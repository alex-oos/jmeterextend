...
public class GettheOrderSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		map_data.put("role", "buyer");
		map_data.put("pageCount", "10");
		map_data.put("order_status", "");
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=orders&op=gettheOrder", "获取订单信息", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GettheOrderSample().runTest(null);
