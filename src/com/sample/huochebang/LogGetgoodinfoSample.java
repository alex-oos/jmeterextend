...
public class LogGetgoodinfoSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=log&op=getgoodinfo", "通过扫商品二维码到确认订单页的浏览记录打点", "POST").run(map);
...
//		SampleResult sampleResult=new LogGetgoodinfoSample().runTest(null);
