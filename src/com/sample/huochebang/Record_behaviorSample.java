...
public class Record_behaviorSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		map_data.put("label", "tire_homepag_caininxuyao");
		map_data.put("values", "{}");
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=Userdata&op=record_behavior", "记录用户行为数据", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new Record_behaviorSample().runTest(null);
