...
public class GetTyreHistorySample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		map_data.put("lng", "116.36309");
		map_data.put("lat", "40.051935");
		map_data.put("page", "1");
		map_data.put("length", "15");
		map_data.put("status", "1");
		map_data.put("astrict", "1");
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=Search&op=getTyreHistory", "浏览过的轮胎", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetTyreHistorySample().runTest(null);
