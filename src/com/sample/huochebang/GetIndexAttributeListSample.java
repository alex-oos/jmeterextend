...
public class GetIndexAttributeListSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new HuoCheBangHttpRequest("/manbang/index.php?act=search&op=getIndexAttributeList", "获取轮胎商城首页筛选列表", "POST").run(map);
	...
	public static void main(String[] args) {
		SampleResult sampleResult=new GetIndexAttributeListSample().runTest(null);
