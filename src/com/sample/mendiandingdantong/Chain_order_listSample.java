...
public class Chain_order_listSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    //服务订单列表
  		...
  		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/chain_order/order_list", "服务订单列表", "POST").run(map);
