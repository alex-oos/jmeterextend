...
public class AddeviceSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		mapcart_count_data.put("memory_avail", "92.14吉字节");
		mapcart_count_data.put("mobile_code", "");
		mapcart_count_data.put("device_model", "MI 8");
		mapcart_count_data.put("app_version", "1.6.9");
		mapcart_count_data.put("device_id", "861608046253413");
		mapcart_count_data.put("dump_energy", "50");
		mapcart_count_data.put("device_imsi", "460026311104916");
		mapcart_count_data.put("network_name", "中国移动");
		mapcart_count_data.put("device_type", "0");
		mapcart_count_data.put("client_type", "android");
		mapcart_count_data.put("is_root", "0");
		mapcart_count_data.put("mobile_country_code", "cn");
		mapcart_count_data.put("add_type", "");
		mapcart_count_data.put("device_system", "android");
		mapcart_count_data.put("device_system_version", "8.1.0");
		mapcart_count_data.put("app_name", "门店订单通");
		mapcart_count_data.put("imei", "861608046253413");
		mapcart_count_data.put("network_type", "13");
		mapcart_count_data.put("mobile_network_code", "460026311104916");
		mapcart_count_data.put("memory_total", "119吉字节");
		mapcart_count_data.put("device_alias", "Xiaomi");
		mapcart_count_data.put("memory_total", "119吉字节");
		mapcart_count_data.put("device_alias", "Xiaomi");
		mapcart_count_data.put("app_code", "21");
		...
		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/app_device/addevice", "添加设备", "POST").run(mapcart_count);
