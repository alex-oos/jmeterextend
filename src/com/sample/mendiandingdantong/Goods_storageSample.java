...
public class Goods_storageSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/chain_goods_offline/goods_storage", "仓库中的商品/待审核的商品", "POST").run(map);
