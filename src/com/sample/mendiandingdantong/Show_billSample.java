...
public class Show_billSample implements JavaSamplerClient {
...
//		list.add("8d17db782f7fe20efc8d499ce8b552bc");
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    //货款结算详情
  		...
  		map_data.put("curpage", "1");
  		map_data.put("state_type", "");
  		map_data.put("ob_id", "61842");
  		...
  		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/chain_order_bill/show_bill", "货款结算详情", "POST").run(map);
	...
	public static void main(String[] args) {
		new Show_billSample().runTest(null);
	}
}
