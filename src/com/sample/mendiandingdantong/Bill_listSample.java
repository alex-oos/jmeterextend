...
public class Bill_listSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    //货款结算列表
  		...
  		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/chain_order/order_list", "货款结算列表", "POST").run(map);
