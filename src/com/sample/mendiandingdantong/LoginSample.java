...
public class LoginSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
		...
		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/member/login", "进行登录", "POST").run(map_login);
	...
	public static void main(String[] args) {
		for (int i = 0; i < list.size(); i++) {
			SampleResult sampleResult=new LoginSample().runTest(null);
