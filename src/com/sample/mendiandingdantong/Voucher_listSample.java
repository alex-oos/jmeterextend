...
public class Voucher_listSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    //个人代金券列表
  		...
  		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/member_voucher/voucher_list", "个人代金券列表", "POST").run(map);
