...
public class GetProspectusStoreListSample implements JavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    //已签约商家
  		...
  		mapuptoken_data.put("curpage", "1");
  		mapuptoken_data.put("pagesize", "15");
		...
		try {
			SampleResult sampleResultsub= new AppHttpRequest("/orderapi/v1/prospectus_store/getProspectusStoreList", "已签约商家", "POST").run(mapuptoken);
