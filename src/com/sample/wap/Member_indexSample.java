...
/**
 * @author lijiang
 * @date 2019/1/8 - 上午 11:54
 */
public class Member_indexSample implements JavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        map_data.put("data", "key="+key);
        try {
            SampleResult sampleResult=new HttpRequest2("/mobile/index.php?act=member_index", "我的商城", "POST").run(map_data);
            return sampleResult;
        } catch (Exception e) {
