...
/**
 * @author lijiang
 * @date 2019/1/8 - 上午 11:51
 */
public class Get_msg_count_goodSample implements JavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        map_data.put("data","");
        try {
            SampleResult sampleResult =new HttpRequest2("/mobile/index.php?act=member_goodsmessage&op=get_msg_count&key="+key ,"获取未读消息数 (商品快讯)","GET").
                    run(map_data);
            return  sampleResult;
        } catch (Exception e) {
            e.printStackTrace();
...
//            SampleResult sampleResult =new Get_msg_count_goodSample().runTest(null);
