...
//	static  int q =0 ;
	...
	public SampleResult runTest(JavaSamplerContext context) {
	    ...
	    String username =(String) list.get(q);
//	    q++;
	    Map map_login =new HashMap<>();

		
		map_login.put("data", "username="+username+"&password=123456&client=wap");

		
		

		try {
			SampleResult  SampleResult= new HttpRequest2("/mobile/index.php?act=login", "进行登录", "POST").run(map_login);
