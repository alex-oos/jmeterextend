...
/**
 * @author lijiang
 * @date 2019/1/8 - 上午 11:43
 */
public class Get_msg_countSample implements JavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        map_data.put("data","");
        try {
            SampleResult sampleResult =new HttpRequest2("/mobile/index.php?act=member_chat&op=get_msg_count&key="+key,"未读消息查询（会员聊天）","POST").
                    run(map_data);
            return  sampleResult;
        } catch (Exception e) {
            e.printStackTrace();
...
//            SampleResult sampleResult =new Get_msg_countSample().runTest(null);
