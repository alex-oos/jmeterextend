...
public class JmxCreater {
	...
	public String toString() {
		...
		throughputController.element.setAttribute("guiclass", "ThroughputControllerGui");
		throughputController.element.setAttribute("testclass", "ThroughputController");
		throughputController.element.setAttribute("testname", "Throughput Controller");
		throughputController.element.setAttribute("enabled", "true");
		...
		throughputController.addSample(customSample);
		
		runThreadGroup.addController(throughputController);
		...
		//添加ThroughputController参数
		
		Element element14= Usualutil.getDocument().createElement("intProp");
		element14.setAttribute("name", "ThroughputController.style");
		element14.setTextContent("1");
		throughputController.element.appendChild(element14);
		
		Element element15= Usualutil.getDocument().createElement("boolProp");
		element15.setAttribute("name", "ThroughputController.perThread");
		element15.setTextContent("false");
		throughputController.element.appendChild(element15);
		
		
		Element element16= Usualutil.getDocument().createElement("intProp");
		element16.setAttribute("name", "ThroughputController.maxThroughput");
		element16.setTextContent("1");
		throughputController.element.appendChild(element16);
		
		Element element17= Usualutil.getDocument().createElement("FloatProperty");
		
		Element element171= Usualutil.getDocument().createElement("name");
		element171.setTextContent("ThroughputController.percentThroughput");
		Element element172= Usualutil.getDocument().createElement("value");
		element172.setTextContent("1.0");
		Element element173= Usualutil.getDocument().createElement("savedValue");
		element173.setTextContent("0.0");
		
		element17.appendChild(element171);
		element17.appendChild(element172);
		element17.appendChild(element173);
	
		throughputController.element.appendChild(element17);
		...
		element19.setTextContent("org.apache.jmeter.protocol.java.test.JavaTest");
		...
		//添加JavaSampler参数
				...
				element35.setTextContent("org.apache.jmeter.visualizers.backend.graphite.GraphiteBackendListenerClient");
	...
	public static void main(String[] args) throws Exception {
		JmxCreater jmxCreater=new JmxCreater();
